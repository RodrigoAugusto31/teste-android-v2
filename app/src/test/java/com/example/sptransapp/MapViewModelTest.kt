...
import com.example.sptransapp.domain.model.*
...
class MapViewModelTest {
    ...
    @Test
    fun `buscarOnibus DEVE atualizar lista e repetir APOS delay QUANDO sucesso`() = runTest(testDispatcher) {
    ...
    @Test
    fun `buscarOnibus DEVE setar mensagem de erro QUANDO repositorio falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `pesquisarLinha NAO DEVE chamar repositorio QUANDO termo eh vazio`() = runTest(testDispatcher) {
    ...
    @Test
    fun `pesquisarLinha DEVE retornar linhas QUANDO sucesso`() = runTest(testDispatcher) {
        val termo = "8000"
    ...
    @Test
    fun `pesquisarLinha DEVE setar erro QUANDO falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `carregarOnibusDaLinha DEVE carregar paradas E iniciar refresh de onibus`() = runTest(testDispatcher) {
        val codigoLinha = 123
    ...
    @Test
    fun `carregarOnibusDaLinha DEVE ignorar erro de paradas MAS continuar buscando onibus`() = runTest(testDispatcher) {
        val codigoLinha = 123
    ...
    @Test
    fun `buscarPrevisaoDaParada DEVE atualizar previsoes QUANDO sucesso`() = runTest(testDispatcher) {
    ...
    @Test
    fun `buscarPrevisaoDaParada DEVE setar erro QUANDO falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `buscarListaCorredores DEVE atualizar lista QUANDO sucesso`() = runTest(testDispatcher) {
    ...
    @Test
    fun `buscarListaCorredores DEVE setar erro QUANDO falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `carregarMapaCorredores DEVE atualizar kmlData QUANDO sucesso`() = runTest(testDispatcher) {
    ...
    @Test
    fun `carregarMapaCorredores DEVE setar erro QUANDO falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `carregarMapaGeral DEVE atualizar kmlData QUANDO sucesso`() = runTest(testDispatcher) {
        val inputStream = mockk<InputStream>()
    ...
    @Test
    fun `carregarMapaGeral DEVE setar erro QUANDO falha`() = runTest(testDispatcher) {
    ...
    @Test
    fun `stopRefresh DEVE cancelar o job`() = runTest(testDispatcher) {
